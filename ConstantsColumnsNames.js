...
const INFESTATION_DETERIORATION_REMARKS = "Infestation / Deterioration Noticed (Remarks)";
...
const STOCK_KEPT_COUNTABLE_REMARKS = "Stock kept in countable position (Remarks)";
const UPLOAD_PHOTO_STOCK_KEPT_COUNTABLE = "Upload Photo - Stock kept in countable position";
...
const HYGIENE_CLEANLINESS_MAINTAINED = "Hygiene / Cleanliness maintained in warehouse";
const HYGIENE_CLEANLINESS_MAINTAINED_REMARKS = "Hygiene / Cleanliness maintained in warehouse (Remarks)";
const UPLOAD_PHOTO_HYGIENE_CLEANLINESS = "Upload photo - Hygiene / Cleanliness maintained in warehouse";
const BANK_FUNDED_COMMODITIES_STORED = "Whether the Bank funded commodities are stored separately and bifurcated";
const BANK_FUNDED_COMMODITIES_DETAILS = "Bank Funded Commodities (Details)";
const UPLOAD_PHOTO_BANK_FUNDED_COMMODITIES = "Upload Photo - Bank Funded commodities";
...
const SECURITY_GUARD_REMARKS = "Security Gaurd Available during visit - Remarks";
const UPLOAD_PHOTO_SECURITY_GUARD = "Upload Photo - Security Guard available during visit";
...
const UPLOAD_PHOTO_SUPERVISOR = "Upload Photo - Supervisor available during visit";
const WAREHOUSE_PERSONAL_ID_CARD_AVAILABLE = "Id card of warehouse personal available";
const WAREHOUSE_PERSONAL_ID_CARD_REMARKS = "Id card of warehouse personal - Remarks";
const UPLOAD_PHOTO_WAREHOUSE_PERSONAL_ID_CARD = "Upload Photo - Id card of warehouse personal available";
...
const UPLOAD_PHOTO_VISITORS_REGISTER = "Upload Photo - Visitors register available";
...
const SECURITY_GUARD_ATTENDANCE_REGISTER_AVAILABLE = "Security guard attendance register available";
const SECURITY_GUARD_ATTENDANCE_REMARKS = "Security guard attendance register available - Remarks";
const UPLOAD_PHOTO_SECURITY_GUARD_ATTENDANCE = "Upload Photo - Security guard's attendance register";
const SUPERVISOR_ATTENDANCE_REGISTER_AVAILABLE = "Supervisor attendance register available";
const SUPERVISOR_ATTENDANCE_REMARKS = "Supervisor attendance register available - Remarks";
const UPLOAD_PHOTO_SUPERVISOR_ATTENDANCE = "Upload Photo - Supervisor's attendance register";
...
const UPLOAD_PHOTO_LEIN_REGISTER = "Upload Photo - Lein register available & Lein marked";
const TYPE_OF_WAREHOUSE = "Type of warehouse";
const SPECIFY_WAREHOUSE_TYPE = "If Others, please specify the warehouse type";
const WAREHOUSE_STOCK_BANK_NAME = "Warehouse stock - Funded stock of - Bank Name";
...
const CONDITION_OF_WAREHOUSE_STRUCTURE_REMARKS = "Condition of warehouse structure - Remarks";
const UPLOAD_PHOTO_CONDITION_OF_STRUCTURE = "Upload Photo - Condition of warehouse structure";
...
const UPLOAD_PHOTO_LEAKAGE_INSIDE = "Upload Photo - Leakage inside the Warehouse";
const OTHER_PARTY_DETAILS = "Other party details - Name of entity";
const REMARKS_AVG_BAG_WEIGHT = "Remarks - Avg. Bag weight (Kg)";
const ELECTRICAL_CONNECTION_INSIDE_WAREHOUSE = "Whether there are any electrical connection inside the warehouse.";
const ELECTRICAL_CONNECTION_SECURITY = "If yes, secured or unsecured";
const TOTAL_QUANTITY_BANK_MT = "Total Quantity available in warehouse as per Bank (MT)";
const TOTAL_BAGS_BANK = "Total Bags available in warehouse as per Bank";
const TOTAL_QUANTITY_AGNEXT_MT = "Total Quantity available in warehouse as per AgNext (MT)";
const TOTAL_BAGS_AGNEXT = "Total Bags available in warehouse as per AgNext";
const QUANTITY_MISMATCH = "Quantity Mismatch";
const MISMATCH_EXCESS_OR_LESSER = "Is the Quantity Mismatched in excess or is lesser";
